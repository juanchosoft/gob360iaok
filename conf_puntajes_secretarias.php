...
<head>
  ...
  <link rel="stylesheet" href="assets/css/configuracion_puntajes_secretaria_gob360_premium.css">
</head>

<body class="gob360-secretariat-score-page">
  <!-- [ Pre-loader ] start -->
  <div class="loader-bg">
  ...
  <div class="pcoded-main-container">
    <div class="pcoded-content">
      ...
      <section class="g360-secretariat-score-hero" aria-label="Configuración de puntajes por secretaría GOB360">
        <div class="g360-secretariat-score-hero__grid">

          <aside class="g360-secretariat-score-brand">
            <span class="g360-secretariat-score-brand__eyebrow">
            ...
            <img
              ...
              alt="Logo GOB360"
              class="g360-secretariat-score-brand__logo"
            >

            <span class="g360-secretariat-score-brand__caption">
              Gestión pública inteligente y territorial
            </span>

            <div class="g360-secretariat-score-brand__status">
              <span></span>
              Matriz sectorial activa
            </div>
          </aside>

          <div class="g360-secretariat-score-hero__content">
            <div class="g360-secretariat-score-hero__top">
              <div>
                <div class="g360-secretariat-score-hero__eyebrow">
                  <i class="feather icon-briefcase"></i>
                  Configuración sectorial
                </div>

                <h1 class="g360-secretariat-score-hero__title">
                  Puntajes por Secretaría
                </h1>

                <p class="g360-secretariat-score-hero__description">
                  Configura rangos y colores para cada secretaría según el tipo
                  de medición utilizado, permitiendo interpretar de forma rápida
                  el comportamiento sectorial dentro de GOB360.
                </p>
              </div>

              <div class="g360-secretariat-score-hero__actions">
                <button
                  type="button"
                ...
                <div class="g360-secretariat-score-back">
                  <?php include './admin/include/btn_back.php'; ?>
                </div>
              </div>
            </div>

            <div class="g360-secretariat-score-summary">
              <article>
                <span class="g360-secretariat-score-summary__icon">
                  <i class="feather icon-briefcase"></i>
                </span>
                ...
                <div>
                  ...
                  <p>Configuración por dependencia</p>
                </div>
              </article>

              <article>
                <span class="g360-secretariat-score-summary__icon g360-secretariat-score-summary__icon--measurement">
                ...
                <div>
                  ...
                  <p>Cantidad, mantenimiento o creación</p>
                </div>
              </article>

              <article>
                <span class="g360-secretariat-score-summary__icon g360-secretariat-score-summary__icon--range">
              ...
              <article>
                <span class="g360-secretariat-score-summary__icon g360-secretariat-score-summary__icon--permissions">
            ...
            <div class="g360-secretariat-score-capabilities" aria-hidden="true">
              <span>
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="tab-content g360-secretariat-score-tabs-content" id="myTabContent">

            <!-- TAB 1 -->
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
              <br>
              <div class="card g360-secretariat-score-card g360-secretariat-score-card--create">
                <div class="card-header d-flex flex-wrap align-items-center justify-content-between py-3">
                  <div class="g360-card-heading">
                    ...
                    <div>
                      <span class="g360-card-heading__eyebrow">Nueva regla sectorial</span>
                      <h5 class="mb-0">Ingresar configuración por secretaría</h5>
                      <p>
                        Selecciona la dependencia, define el tipo de medición y
                        establece el rango con su color asociado.
                      </p>
                    </div>
                  </div>
                ...
                <div class="card-body">
                  <form id="formupuntajes" role="form" autocomplete="false">
                    ...
                    <div class="g360-form-section-heading">
                      ...
                      <div>
                        <span>Dependencia y medición</span>
                        <h6>Identificación de la regla sectorial</h6>
                        <p>
                          Selecciona la secretaría y el método con el que será evaluada.
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="g360-form-section-heading">
                      <span class="g360-form-section-heading__icon g360-form-section-heading__icon--visual">
                        <i class="feather icon-droplet"></i>
                      </span>

                      <div>
                        <span>Representación visual</span>
                        <h6>Color de la clasificación</h6>
                        <p>
                          Asigna el color que identificará este rango en los reportes.
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="g360-secretariat-score-save-bar">
                      <div class="g360-secretariat-score-save-bar__message">
                        <i class="feather icon-info"></i>
                        <span>
                          Verifica que el rango no se superponga con otra regla de
                          la misma secretaría y tipo de medición.
                        </span>
                      </div>

                      <div class="g360-secretariat-score-save-bar__actions">
                        <button
                          type="button"
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
              <br>
              <div class="card g360-secretariat-score-card g360-secretariat-score-card--list">
                <div class="card-header d-flex flex-wrap align-items-center justify-content-between py-3">
                  <div class="g360-card-heading">
                    ...
                    <div>
                      <span class="g360-card-heading__eyebrow">Matriz sectorial</span>
                      <h5 class="mb-0">Listado de configuraciones por secretaría</h5>
                      <p>
                        Consulta, filtra y edita los rangos sectoriales registrados.
                      </p>
                    </div>
                  </div>
                  <div class="card-header-right ml-auto">
                ...
                <div class="card-body table-border-style">
                  <div class="g360-secretariat-score-tools">
                    <div class="g360-secretariat-score-search">
                      <span class="g360-secretariat-score-search__icon">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          id="customSearch"
                          class="form-control"
                          placeholder="Buscar secretaría, medición, rango o color..."
                        >
                      </div>
                    </div>

                    <div class="g360-secretariat-score-tools__info">
                      <i class="feather icon-info"></i>
                      <span>
                        Cada registro representa un rango aplicable a una secretaría
                        y a un tipo específico de medición.
                      </span>
                    </div>
                  </div>

                  <div class="table-responsive tabla-informacion tabla-scroll g360-secretariat-score-table">
                    <table class="table table-hover mb-0" id="dynamictable" aria-label="Configuraciones de puntajes por secretaría">
                      <thead style="">
                        <tr class="border-1">
                          <th>Editar</th>
                          <th>Secretaría</th>
  ...
  <div class="modal fade" id="modalEditSecretario" tabindex="-1" role="dialog" aria-labelledby="modalSecretariaLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
      <div class="modal-content g360-secretariat-score-modal">
        <div class="modal-header">
          <div class="g360-modal-heading">
            ...
            <div>
              <small>Actualización sectorial</small>
              <h5 class="modal-title" id="modalSecretariaLabel">
                Editar puntaje por secretaría
              </h5>
            </div>
          </div>
        ...
        <div class="modal-body">
          <div class="g360-secretariat-score-modal__intro">
            <span>
              <i class="feather icon-shield"></i>
            </span>
            ...
            <div>
              ...
              <p>
                Modifica la secretaría, el tipo de medición, el rango o el color
                conservando los identificadores usados por el sistema.
              </p>
            </div>
          </div>
          ...
          <form id="formupuntajesEdit" role="form" autocomplete="off">
            ...
            <div class="g360-modal-section-heading">
              ...
              <div>
                ...
                <h6>Datos de la regla sectorial</h6>
              </div>
            </div>
        ...
        <div class="modal-footer">
          <div class="g360-modal-footer-message">
            <i class="feather icon-lock"></i>
            La actualización quedará aplicada a esta regla sectorial.
          </div>
