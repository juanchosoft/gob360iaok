...
// Permisos
requirePermission('configuracion.estrategias.view');
$view = SessionData::hasPermission('configuracion.estrategias.view');
$create = SessionData::hasPermission('configuracion.estrategias.create');
$edit = SessionData::hasPermission('configuracion.estrategias.update');
...
<head>
  ...
  <style>
    ...
    .table-hover tbody tr:hover{
      ...
      color: rgba(250, 243, 243, 0.86) !important;
    }
    ...
    /* tu modal trae bg-primary text-white; lo elevamos a degradado premium */
    .modal-header.bg-primary{
      background: linear-gradient(135deg, rgba(79,124,255,.55), rgba(155,92,255,.40)) !important;
      border-bottom: 1px solid rgba(255,255,255,.12) !important;
    }
    .modal-title{ font-weight: 900 !important; letter-spacing: .2px; color: #fff !important; }
    .modal-footer{
    ...
    label{ color: var(--muted) !important; font-weight: 900; }
  ...
  <div class="pcoded-main-container">
    <div class="pcoded-content">
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <div class="d-flex justify-content-between align-items-center">
                <h5 class="m-b-10">Estrategia</h5>
                <?php include './admin/include/btn_back.php'; ?>
              </div>
              <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                <li class="breadcrumb-item"><a href="#!">Configuración General / Estrategia</a></li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="contenedor">
        <div class="contenido">
          <div class="card">
            <div class="card-header d-flex flex-wrap align-items-center justify-content-between py-3">
              <h5 class="mb-0 text-center w-100">Ingreso y listado de estrategia</h5>
        ...
        <!-- Modal Estrategia -->
        <div class="modal fade" id="modalEstrategia" tabindex="-1" role="dialog" aria-labelledby="modalEstrategiaLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg" role="document">
            <form id="formEstrategia">
              <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                  <h5 class="modal-title" id="modalEstrategiaLabel">Nueva Estrategia</h5>
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-primary" id="btnGuardarEstrategia" onclick="guardarEstrategia()">Guardar</button>
                </div>
              </div>
            </form>
          </div>
