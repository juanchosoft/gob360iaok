...
// Permisos
requirePermission('configuracion.lineas.view');
$view = SessionData::hasPermission('configuracion.lineas.view');
$create = SessionData::hasPermission('configuracion.lineas.create');
$edit = SessionData::hasPermission('configuracion.lineas.update');
$permits = SessionData::hasPermission('configuracion.lineas.update');
...
<head>
  ...
  <style>
    ...
    .modal-title{ font-weight: 900 !important; letter-spacing: .2px; color: var(--txt) !important; }
    .modal-footer{
    ...
    /* Make “bg-light text-dark” header not conflict (force dark style) */
...
<body class="">
  ...
  <div class="pcoded-main-container">
    <div class="pcoded-content">
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <div class="d-flex justify-content-between align-items-center">
                <h5 class="m-b-10">Líneas</h5>
                <?php include './admin/include/btn_back.php'; ?>
              </div>
              <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php"><i class="feather icon-home"></i></a></li>
                <li class="breadcrumb-item"><a href="#!">Configuración General / Ingreso y listado de líneas</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="contenido">
          <div class="card">
            <div class="card-header d-flex flex-wrap align-items-center justify-content-between py-3">
              <h5 class="mb-0 text-center w-100">Ingreso y listado de línea</h5>
      ...
      <!-- Modal -->
      <div class="modal fade" id="modalLinea" tabindex="-1" role="dialog" aria-labelledby="modalLineaLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
          <form id="formLinea" class="w-100" autocomplete="off">
            <input type="hidden" name="id" id="ministerioId" />
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="modalLineaLabel">Linea</h5>
              ...
              <div class="modal-body" style="padding: 15px;">
                ...
                <div class="form-group col-md-8 offset-md-2">
                  ...
                  <textarea class="form-control" id="descripcion" name="descripcion" required rows="4"></textarea>
              ...
              <div class="modal-footer">
                ...
                <button type="button" id="btnGuardarLinea" class="btn btn-primary">Guardar</button>
              </div>
            </div>
          </form>
        </div>
