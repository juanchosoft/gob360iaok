...
if (!isset($_GET['depto_id'])) {
    header("Location: resumenalcaldias.php?depto_id=21#!");
    exit;
}
?>
                        ...
                        <div class="page-wrapper">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <h5 class="m-b-10">Resumen alcaldias</h5>
                                                <?php include './admin/include/btn_back.php'; ?>
                                            </div>
                                            <ul class="breadcrumb">
                                                <li class="breadcrumb-item"><a href="index.html"><i
                                                            class="feather icon-home"></i></a></li>
                                                <li class="breadcrumb-item"><a href="#!">Resumen alcaldias</a></li>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="floating-label" for="Eje">Alcaldia<span
