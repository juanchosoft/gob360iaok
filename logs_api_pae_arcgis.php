...
<style>
    ...
    .badge-api { background: #f5c6cb; color: #721c24; font-weight: 800; }
    .badge-bd { background: #ffe5b4; color: #8b4513; font-weight: 800; }
...
<body class="">
        ...
        <div class="pcoded-content">
                            ...
                            <div class="page-header-title d-flex align-items-center justify-content-between">
                                <div>
                                    ...
                                    <p class="text-muted mb-0">
                                        Registro de todas las peticiones a la API REST de ArcGIS Online
                                    </p>
                                </div>
                                <div>
                                    <span class="header-api-badge">
                                        <i class="feather icon-cloud"></i> Monitor ArcGIS PAE
                                    </span>
                                    <a href="pae_arcgis_dash.php" class="btn btn-outline-primary btn-sm ml-2">
            ...
            <div class="row mb-4" id="statsContainer">
                <div class="col-lg-2 col-md-4 col-6 mb-3">
                    <div class="stat-card">
                        <div class="stat-label"><i class="feather icon-send"></i> Total Peticiones</div>
                        <div class="stat-number text-primary" id="statTotal">-</div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6 mb-3">
                    <div class="stat-card">
                        <div class="stat-label"><i class="feather icon-check-circle" style="color:var(--ok);"></i> Exitosas</div>
                        <div class="stat-number text-success" id="statOk">-</div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6 mb-3">
                    <div class="stat-card">
                        <div class="stat-label"><i class="feather icon-alert-triangle" style="color:var(--bad);"></i> Con Error</div>
                        <div class="stat-number text-danger" id="statErrores">-</div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6 mb-3">
                    <div class="stat-card">
                        <div class="stat-label"><i class="feather icon-clock" style="color:var(--info);"></i> Tiempo Prom. (seg)</div>
                        <div class="stat-number text-info" id="statTiempo">-</div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6 mb-3">
                    <div class="stat-card">
                        <div class="stat-label"><i class="feather icon-activity" style="color:var(--warn);"></i> Últimas 24h</div>
                        <div class="stat-number text-warning" id="stat24h">-</div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-6 mb-3">
                    <div class="stat-card">
                        <div class="stat-label"><i class="feather icon-database"></i> Features Totales</div>
                        <div class="stat-number text-dark" id="statFeatures">-</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-control" id="filtroEstado">
                                ...
                                <option value="ERROR_BD">Error BD</option>
                            </select>
                        </div>
                        <div class="col-md-2">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6><i class="feather icon-list"></i> Historial de Peticiones ArcGIS</h6>
    ...
    <!-- Script de logs PAE ArcGIS -->
    <script src="<?php echo Util::versionar('./admin/js/logs_api_pae_arcgis.js'); ?>"></script>
</body>
</html>
