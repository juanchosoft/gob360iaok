...
<head>
    ...
    <style>
        ...
        /* Table in modal: dark + clean */
        .modal-table-au{ width:100%; border-collapse:collapse; color: var(--txt); }
        .modal-table-au thead th{
            background: rgba(255,255,255,.06) !important;
            border-bottom: 1px solid rgba(255,255,255,.12) !important;
        ...
        .modal-table-au tbody td{
            border-bottom: 1px solid rgba(255,255,255,.05) !important;
            color: rgba(255,255,255,.88) !important;
            padding: 12px 12px !important;
            font-size: 14px;
        }
        .modal-table-au tbody tr:last-child td{ border-bottom: none !important; }
        .modal-table-au tbody tr:hover td{ background: rgba(255,255,255,.04) !important; }
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    ?>
                    <table class="modal-table-au">
                        <thead>
                            <tr>
                                <th><?php echo $labelPrincipal; ?></th>
                                <th style="text-align:center;">Veces Visitado</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            if (isset($arrVisitadas) && isset($isvalidVisitadas) && $isvalidVisitadas && count($arrVisitadas) > 0) {
                                foreach ($arrVisitadas as $item) { ?>
                                    <tr>
                                        ...
                                        <td style="text-align:center;"><?php echo htmlspecialchars($item['veces_visitado']); ?></td>
                                    </tr>
                                <?php }
                            } else { ?>
                                <tr>
                                    <td colspan="2" style="text-align:center;padding:30px;color:var(--muted2);font-weight:800;">
                    ...
                    <table class="modal-table-au">
                        ...
                        <tbody>
                            ...
                            if (isset($arrRestantes) && isset($isvalidRestantes) && $isvalidRestantes && count($arrRestantes) > 0) {
                                ...
                                <tr>
                                    <td style="text-align:center;padding:30px;color:var(--muted2);font-weight:800;">
